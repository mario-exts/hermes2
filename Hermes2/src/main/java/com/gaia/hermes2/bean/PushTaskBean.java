...
public class PushTaskBean extends AbstractMongoBean {
	...
	public PuObject toPuObject() {
		...
		puo.set(F.APNS_COUNT, this.apnsCount);
		puo.set(F.GCM_COUNT, this.gcmCount);
		puo.set(F.APNS_SUCCESS_COUNT, this.apnsSuccessCount.intValue());
		puo.set(F.GCM_SUCCESS_COUNT, this.gcmSuccessCount.intValue());
